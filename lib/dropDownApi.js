  ...
  _createClass(DropDown, [{
    ...
    value: function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
        var searchCriteria, carQuery, models;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                carQuery = new _carQuery.CarQuery();
                _context6.next = 5;
                return carQuery.getModels(searchCriteria).then(function (models) {
                  return models;
                });

              case 5:
                models = _context6.sent;
                return _context6.abrupt("return", this.sortModels(models));
    ...
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
        ...
        var trimsArr, searchCriteria, carQuery, trims;
    ...
    value: function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(modelId) {
        var id, carQuery, data;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                id = modelId ? modeId : this.model_id;
    ...
    value: function getEngine(data) {
      ...
      var cylinders = data.engineCyclinders + " Cylinders";
      var engSizeLiters = data.engineCC / 1000;
      var roundedEngSizeLiters = Number(Math.round(engSizeLiters + 'e1') + 'e-1') + ' L ';
